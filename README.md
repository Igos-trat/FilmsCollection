...
- Асинхронная загрузка метаданных и постеров 
...
- Своя коллекция фильмов реализована через CoreData
...
- При выполнении задания не использовались сторонние библиотеки
- Гибко настроенная струтура приложения 
---
# Визуальная часть
## Главный экран
